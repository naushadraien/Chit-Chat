...
export const irelandCountryData = {
  name: "Ireland",
  dial_code: "+353",
  code: "IE",
  flag: "🇮🇪",
...
export const getCountryFromName = (name: string): CountryType => {
  return (
    countriesData.find((country) => country.name === name) || irelandCountryData
  );
};

export const getCountryFromCode = (code: string): CountryType => {
  return (
    countriesData.find((country) => country.dial_code === code) ||
    irelandCountryData
  );
};
